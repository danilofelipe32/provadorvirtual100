...
const WardrobePanel: React.FC<WardrobePanelProps> = ({ onGarmentSelect, activeGarmentIds, isLoading, wardrobe }) => {
    ...
    }, [wardrobe, searchQuery, sortOption]);
    ...
    <div className="pt-6 border-t border-gray-400/50">
        ...
        <div className="flex flex-col sm:flex-row gap-2 mb-4">
            ...
            <select
                ...
                className="w-full sm:w-auto px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-gray-800"
            >
