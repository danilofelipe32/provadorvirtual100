...
const WardrobeModal: React.FC<WardrobeModalProps> = ({ isOpen, onClose, onGarmentSelect, activeGarmentIds, isLoading }) => {
    ...
    const handleGarmentClick = async (item: WardrobeItem) => {
        ...
        try {
            ...
            setError('Não foi possível carregar o item do guarda-roupa. Por favor, tente novamente.');
        }
    };
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        if (e.target.files && e.target.files[0]) {
            ...
            const customGarmentInfo: WardrobeItem = {
                ...
                // FIX: Add missing 'dateAdded' property to satisfy the WardrobeItem type.
                dateAdded: Date.now(),
            };
            ...
            >
                ...
                >
                    <div className="flex items-center justify-between p-4 border-b">
                        <h2 className="text-2xl font-serif tracking-wider text-gray-800">Adicionar Peça</h2>
