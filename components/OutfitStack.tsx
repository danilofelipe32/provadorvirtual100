...
const OutfitStack: React.FC<OutfitStackProps> = ({ outfitHistory, onRemoveLastGarment }) => {
  return (
    <div className="flex flex-col">
      <h2 className="text-xl font-serif tracking-wider text-gray-800 border-b border-gray-400/50 pb-2 mb-3">Seu Look</h2>
      <div className="space-y-2">
        ...
        {outfitHistory.length === 1 && (
            <p className="text-center text-sm text-gray-500 pt-4">Suas peças aparecerão aqui. Selecione um item do guarda-roupa abaixo.</p>
        )}
      </div>
    </div>
  );
