  ...
  const handleFileSelect = useCallback(async (file: File) => {
    ...
    reader.onload = async (e) => {
        ...
        try {
            ...
            setError(getFriendlyErrorMessage(err, 'Falha ao criar modelo'));
          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Já imaginou como uma roupa ficaria em você? Pare de adivinhar. Envie uma foto e veja com seus próprios olhos. Nossa IA cria seu modelo pessoal, pronto para provar qualquer coisa.
              </p>
